...
export const DisputedReviewById = () => {
  ...
  const handleResolve = async () => {
    if (!selected) {
      message.error("Please select either Approve or Remove before resolving.");
      return;
    }
      ...
      {observeData?.data?.status === 'resolved' ? (
        ...
        <>
          ...
          <PrimaryButton
            ...
            disabled={!selected || isLoading} // Disable button if nothing is selected or API is loading
          >
